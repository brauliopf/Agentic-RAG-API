...
def load_vector_store(embeddings: Embeddings, user_id: Optional[str]) -> VectorStore:
    """
    ...
    if store_type == "in_memory":
        ...
        try:
            ...
            logger.info("Created Pinecone vector store", index_name=settings.pinecone_index, namespace=user_id)
            return vector_store
